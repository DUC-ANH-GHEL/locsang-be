...
from app.presentation.api.public_api.cache import PUBLIC_CACHE_CONTROL
from app.presentation.api.public_api.endpoints.accounts import router as accounts_router
from app.presentation.api.public_api.endpoints.categories import router as categories_router
from app.presentation.api.public_api.endpoints.home import router as home_router
...
public_api_router.include_router(categories_router)
public_api_router.include_router(home_router)
