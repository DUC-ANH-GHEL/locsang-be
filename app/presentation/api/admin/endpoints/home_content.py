...
def _default_home_payload() -> Dict[str, Any]:
    return {
        ...
        "footer_desktop_caption": "Phụ tùng và dầu nhớt Yanmar chính hãng, quản lý trực tiếp bởi Lộc Sang.",
        "footer_mobile_description": "Phụ tùng, dầu nhớt Yanmar chính hãng.",
